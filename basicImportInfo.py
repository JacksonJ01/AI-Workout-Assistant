...
from PyQt5.QtWidgets import QApplication, QDateEdit, QGridLayout, QLabel, QLineEdit, QMainWindow, QPushButton, QScrollArea, QTableView, QTimeEdit, QTableWidget, QVBoxLayout, QWidget
